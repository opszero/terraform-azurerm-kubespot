...
| <a name="input_ad_user_ids"></a> [ad\_user\_ids](#input\_ad\user\_ids)                                   | Active Directory users and a new AD group will be created, and the group will be attached to the cluster.   | `list` | `[]` | no |
